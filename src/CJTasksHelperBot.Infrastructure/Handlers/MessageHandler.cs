...
public class MessageHandler : IMessageHandler
{
    ...
    public MessageHandler(ICommandService commandService, IUserService userService, IChatService chatService,
        IUserChatService userChatService, ICacheService commandStateService, IStepService stepService,
        MapperlyMapper mapper, ILocalizationService localizationService)
    {
